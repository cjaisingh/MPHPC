...
?>
    <article id="article1">
        ...
        <div class="articleBody clear">
            <p>The database connection is defined in .settings/settings.php, this uses mysql (mainly because <a
                    href="https://github.com/facebook/hhvm">hhvm</a> does not support mysqli).</p>
            ...
            <p>Closing the connection (this isn't needed, but it's nice to clean up after yourself instead of keeping
                unneeded connections open.</p>
