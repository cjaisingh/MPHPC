...
<article id="article2">
	<h1>Setup</h1>
	<div class="articleBody clear">
		<p>Installation is relatively straight forward, however there is some additional setup required for some features.</p>
		<ol role="list">
			...
			<li role="listitem">(optional) If you require custom error pages, update .settings/errors.conf, and include this file in your virtual host.</li>
