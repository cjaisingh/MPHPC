...
?>
    <article id="article1">
        ...
        <div class="articleBody clear">
            <p>Hooks are stored in .hooks, these are predefined scripts that should be ran when such an event
                happens.</p>
            ...
            <ol role="list">
                <li role="listitem"><a href="http://dl.google.com/closure-compiler/compiler-latest.zip">Closure
                        Compiler</a> in /bin/closure-compiler.jar (this requires the <a
